...
public class HackerRankCodeSimple18QueueStack {

    private final Queue<Character> queue = new LinkedBlockingQueue<>();
    ...
    public static void main(String[] args) {
        ...
        HackerRankCodeSimple18QueueStack p = new HackerRankCodeSimple18QueueStack();
